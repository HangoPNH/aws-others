...
api_gateway_domain = "api-gateway.infra.company.com"
...
### Rebuild ###
rebuild_alb_endpoint = "rebuild-ecs-alb.infra.company.com"
rebuild_be_rest_port = "4000"

### API Side Effect ###
api_se_alb_endpoint = "api-se-ecs-alb.infra.company.com"
api_se_rest_port = "4002"

### Safesense ###
safesense_alb_endpoint = "ss-ecs-alb.infra.company.com"
